  ...
  <div class="space-y-6">
    <div class="md:flex md:items-center md:justify-between">
      <div class="flex-1 min-w-0">
        ...
        <p class="mt-2 text-lg text-gray-600">Gerencie locações ativas, devoluções e histórico.</p>
      </div>
      <div class="mt-4 flex md:mt-0 md:ml-4">
        <BaseButton variant="gradient" @click="$router.push('/rentals/create')" icon="Plus">
          Nova Locação
        </BaseButton>
      </div>
    </div>
    ...
    <BaseCard variant="glass" padding="large">
      <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-5">
        ...
        <div>
          <label class="block text-sm font-semibold text-gray-700 mb-2">Data de Locação</label>
          <el-date-picker
        ...
        <div>
          <label class="block text-sm font-semibold text-gray-700 mb-2">Data de Devolução</label>
          <el-date-picker
      ...
      <div class="overflow-x-auto">
        <table class="min-w-full divide-y divide-gray-200/50">
          ...
          <tbody class="bg-white/50 divide-y divide-gray-200/30">
            <tr
              v-for="rental in displayedRentals"
              :key="rental.id"
            ...
            >
              <td class="px-6 py-4 whitespace-nowrap">
                <div class="flex items-center">
                  <div class="flex-shrink-0 h-12 w-12">
                    <div
                      class="h-12 w-12 rounded-full bg-gradient-to-br from-sky-500 to-purple-600 flex items-center justify-center shadow-lg"
                    >
                  ...
                  <div class="ml-4">
                    ...
                    <div class="text-sm text-gray-600">{{ rental.client.email }}</div>
                  </div>
                </div>
              </td>
              ...
              <td class="px-6 py-4 whitespace-nowrap">
                <div class="text-sm text-gray-900 font-medium">{{ rental.user.name }}</div>
                <div class="text-sm text-gray-600">{{ formatCpf(rental.user.document) }}</div>
              </td>
            ...
            <tr v-if="displayedRentals.length === 0">
              ...
              >
                <div class="flex flex-col items-center justify-center">
                  ...
                  <p class="text-lg font-semibold text-gray-900 mb-2">Nenhuma locação encontrada</p>
                  <p class="text-gray-600">Tente ajustar os filtros ou crie uma nova locação.</p>
                </div>
              </td>
            </tr>
          </tbody>
...
import { Search, UserFilled, Tickets, Close, Film, User, Calendar } from '@element-plus/icons-vue'
